...
packages=("git" "zsh" "zsh-completions" "zsh-syntax-highlighting" "firefox" "neovim" "picom" "polybar" "gcc" "python" "code" "alacritty" "rofi" "xournalpp" "networkmanager" "network-manager-applet" "jq" "udisks2" "ntfs-3g" "openssh" "syncthing" "keepassxc" "libreoffice-still")
